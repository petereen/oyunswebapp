...
export function AdminSettings() {
  ...
  return (
    <div className="space-y-4">
      ...
      <section className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl space-y-4">
        <div><h4 className="font-semibold text-blue-800 dark:text-blue-300 flex items-center gap-2"><Settings className="w-4 h-4" /> Telegram тохиргоо</h4><p className="text-xs text-blue-600 dark:text-blue-400 mt-1">Inbox дээрх “Групп рүү илгээх” үйлдлийн дараа сонгосон хүсэлтийг энэ группт илгээнэ.</p></div>
      ...
      <section className="p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl space-y-4">
        <h4 className="font-semibold text-amber-800 dark:text-amber-300 flex items-center gap-2"><Settings className="w-4 h-4" /> Лимит ба хязгаар</h4>
      ...
      <section className="p-4 bg-white dark:bg-dark-800 border border-slate-200 dark:border-dark-600 rounded-xl space-y-4">
        <h4 className="font-semibold text-slate-800 dark:text-ivory-200 flex items-center gap-2"><Settings className="w-4 h-4 text-maroon-600" /> OYUNS Plus ба нэмэлт</h4>
