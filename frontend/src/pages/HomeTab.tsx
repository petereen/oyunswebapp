...
import { User, UserPlus, ArrowDownLeft, ArrowUpRight, ArrowLeftRight, Loader2, Clock, AlertCircle, Sun, Moon } from "lucide-react";
  ...
  if (isAuthenticating) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
        ...
        <div className="text-lg font-medium text-dark-800 dark:text-ivory-200">Нэвтэрч байна...</div>
        <div className="text-sm text-dark-600 dark:text-ivory-300">Түр хүлээнэ үү</div>
      </div>
    );
  }
  ...
  if (authError) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
        ...
        <div className="text-lg font-medium text-red-700 dark:text-red-400">Нэвтрэлт амжилтгүй</div>
        <div className="text-sm text-dark-600 dark:text-ivory-300 text-center max-w-md">{authError}</div>
        <div className="text-xs text-dark-600 dark:text-ivory-400 mt-2">Telegram Mini App-аас нээнэ үү</div>
      </div>
    );
  }
    ...
    <div className="space-y-5 animate-fadeIn">
      ...
      <div className="flex items-center justify-between pt-1">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <div className="text-[11px] text-dark-600 dark:text-ivory-300 font-medium">Тавтай морил</div>
            <div className="text-base font-bold text-dark-800 dark:text-ivory-200">{user?.first_name || "Хэрэглэгч"}</div>
          </div>
        </div>
      ...
      {!isVerified && !pendingVerification && needsRegistration && (
        <div className="bg-white dark:bg-dark-800 p-6 rounded-3xl shadow-card border border-silver/60 dark:border-dark-600 animate-slideUp">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <div className="text-base font-bold text-dark-800 dark:text-ivory-200 mb-0.5">Бүртгүүлэх шаардлагатай</div>
      ...
      {pendingVerification && (
        <div className="bg-white dark:bg-dark-800 p-5 rounded-3xl shadow-card border border-silver/60 dark:border-dark-600 animate-slideUp">
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="text-sm font-bold text-dark-800 dark:text-ivory-200 mb-0.5">Баталгаажуулалт хүлээгдэж байна</div>
              <div className="text-xs text-dark-600 dark:text-ivory-300">Таны бүртгэлийг админ шалгаж байна</div>
              <div className="text-[11px] text-dark-600 dark:text-ivory-400 mt-1">Баталгаажуулалт дууссаны дараа Telegram чатаар мэдэгдэл очих болно</div>
            </div>
          </div>
        </div>
      )}
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-[11px] text-dark-600 dark:text-ivory-400 mt-1">
                Москва 04:00-23:00 / УБ 09:00–04:00
              </div>
            </div>
          </div>
        </div>
